...
// В качестве домашней работы доделать рефакторинг программы,
// с учетом создания нами на уроке ранее функций для записи, чтения, добавления,
// удаления и отображения продуктов в холодильнике.
/*
## HW-25-TEXT
