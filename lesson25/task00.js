...
2. Переработайте программу с урока или из п.1 так, чтобы ввод прекращался на слова "exit" или "выход" или "стоп" или
...
async function runFridgeApp() {
    ...
    console.log('Введите "выход" или "exit" или "стоп" или "stop" в качестве названия, чтобы завершить ввод.\n');
